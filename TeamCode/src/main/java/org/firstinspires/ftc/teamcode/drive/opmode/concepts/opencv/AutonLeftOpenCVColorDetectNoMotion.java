...
@Autonomous(name = "Auton Left w/OpenCV Color detector - no motion", group = "visiontest")
public class AutonLeftOpenCVColorDetectNoMotion extends LinearOpMode {
        ...
        */
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() & runtime.seconds() < 2.0) {
                ...
                telemetry.addData("output targetZone string", targetZone);
                telemetry.update();
            }
            /*
