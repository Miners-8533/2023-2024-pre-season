...
import org.firstinspires.ftc.teamcode.drive.opmode.concepts.opencv.AutonLeftOpenCVColorDetect;
...
@Disabled
@Autonomous(name = "Auton Left w/OpenCV Color Detection", group = "visiontest")
public class AutonLeftUpdatedVisionOpenCVColorDetection extends LinearOpMode {
