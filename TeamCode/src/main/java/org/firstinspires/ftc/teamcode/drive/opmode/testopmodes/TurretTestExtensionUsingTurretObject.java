...
@Disabled
@Autonomous(name="TT: Extension - Object", group="Turret Test")
public class TurretTestExtensionUsingTurretObject extends LinearOpMode {
...
//        plan = new AutonPlan(turret, loadPosition, unloadPosition);
        ...
        while(opModeIsActive()){
            ...
            turret.moveTo(new TurretPosition(0,0, 50, 1));
