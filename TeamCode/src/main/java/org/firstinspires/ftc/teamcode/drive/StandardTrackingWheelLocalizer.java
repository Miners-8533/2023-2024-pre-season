...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.56; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.25; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.996109552;
    public static double Y_MULTIPLIER = 1.016905815;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                new Pose2d(0.625, LATERAL_DISTANCE / 2, 0), // left
                new Pose2d(-0.625, -LATERAL_DISTANCE / 2, 0), // right
