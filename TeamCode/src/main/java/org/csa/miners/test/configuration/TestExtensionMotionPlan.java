...
@Disabled
@Autonomous(name="MotionPlan - Extension", group="MotionPlan Tests")
public class TestExtensionMotionPlan extends MotionPlanTestOpmode {

    @Override
    public MotionPlan getMotionPlan(Turret turret) {
        plan = new MotionPlan(turret);
        plan.add(new TurretPosition(0, 0, 0, 0));
        plan.add(new TurretPosition(0, 0, 200, 0));
        plan.add(new TurretPosition(0, 0, 0, 0));
        return plan;
    }
}
