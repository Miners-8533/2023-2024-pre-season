...
@Disabled
@Autonomous(name="MotionPlan - Composite Motion w/ Wait", group="MotionPlan Tests")
public class TestCompositeMotionPlanWithPause extends MotionPlanTestOpmode {
    ...
    public MotionPlan getMotionPlan(Turret turret) {
        ...
        plan.add(new WaitElement(10000));
